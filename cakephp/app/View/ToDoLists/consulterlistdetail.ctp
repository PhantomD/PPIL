<div data-role="page" data-theme="a" id="page_mainScreen">
  ...
  data-collapsed-icon=' . $icone . ' data-expanded-icon=' . $icone . " data-iconpos='left' >";?>
        ...
        <div class="ui-grid-b center">
            ...
            <div class="ui-block-b"><a href="#popupEditTask" data-role="button" data-rel="popup" data-inline="true"
                                       data-icon="edit" data-iconpos="notext" data-mini="true">Modifier tâche</a></div>

            <div class="ui-block-c"><a href="#popupAddComment" data-role="button" data-rel="popup" data-inline="true"
                                       data-icon="comment" data-iconpos="notext" data-mini="true">Ajouter
                    commentaire</a></div>
        </div>
