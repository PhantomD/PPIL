<div data-role="page" data-theme="a" id="page_mainScreen">
    ...
    <div data-role="content">
        ...
        for ($ligne = 0; $ligne < $this->requestAction('/Tasks/taillelist'); $ligne++) {
            ...
            echo $name;
            echo $this->form->button('f', array('type' => 'button', 'name' => 'aa', 'id' => 'name', 'value' => '', 'data-inline' => 'true', 'data-icon' => 'carat-r', 'data-iconpos' => 'notext', 'data-mini' => 'true', 'onclick' => "location.href='" . $this->Html->url($url) . "'")); ?>
            <br> <?php
        }
        ?>
        <br/>
