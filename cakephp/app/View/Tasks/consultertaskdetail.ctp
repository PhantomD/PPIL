<div data-role="page" data-theme="a" id="page_mainScreen">
    <div data-role="header" data-position="inline" data-theme="a">
        <h1>Consultation détailée de la tâche</h1>

        <div data-role="controlgroup" data-type="horizontal" data-mini="true" class="ui-btn-right">


            <?php echo $this->Html->link('Rafraichir', array('controller' => 'Tasks', 'action' => 'consultertaskdetail'), array('data-role' => 'button', 'data-inline' => true, 'data-icon' => 'recycle', 'data-iconpos' => 'notext', 'data-mini' => true)); ?>
            ...
            <a href="#popupMenu" data-role="button" data-rel="popup" data-inline="true" data-icon="bars"
               data-iconpos="notext" data-mini="true" data-transition="slidedown">Menu</a>
            ...
            <a href="#popupDisconnect" data-role="button" data-rel="popup" data-inline="true" data-icon="back"
    ...
    <div data-role="content">
        <h4 class="ui-bar ui-bar-a">Détails Task : <?php echo $name[0]['Task']['name'] ?></h4>
    </div>
</div>
</div>
