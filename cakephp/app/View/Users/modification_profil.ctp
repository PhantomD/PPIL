...
<div data-role="page" data-theme="b" id="page_option">
    ...
    <div data-role="content">
        ...
        <label>
            ...
            <a href="#popupDelete" data-role="button" data-rel="popup"
               style='margin-left:auto;margin-right: auto;width:70%;'>Supprimer le compte</a>

            <div data-role="popup" id="popupDelete" data-position-to="window" data-overlay-theme="b" data-theme="b"
                 data-dismissible="false" style="max-width:400px;">
                <div data-role="header" data-theme="a"><h1>Supprimer le compte</h1></div>
                <div role="main" class="ui-content">
                    <h3 class="ui-title">Pour confirmer la suppression de votre compte, veuillez saisir votre mot de
                        passe</h3>
