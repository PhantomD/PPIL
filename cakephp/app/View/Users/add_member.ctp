    ...
    <div data-role="content" style="margin-top: 20px;">
        ...
        if (!empty($amis)) {
            ...
            foreach ($amis as $key => $value) {
                ...
                echo $this->html->link($this->html->image("plus-user.png"), array(''), array('id' => $value['id'], 'class' => 'ajax', 'onclick' => 'add_member(this)', 'data-ajax' => 'false', 'escape' => false));
                echo "</td>";
            ...
            echo "Aucun ami disponible";
        }


        ?>
        <p id="idliste" style="visibility: hidden"><?php echo $liste; ?></p>
        <?php echo $this->Html->script('add_member'); ?>
    </div>
</div>
